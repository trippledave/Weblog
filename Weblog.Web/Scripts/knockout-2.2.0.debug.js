...
ko.observableArray['fn'] = {
    ...
    'removeAll': function (arrayOfValues) {
        ...
        // If you passed an arg, we interpret it as an array of Entry to remove
        if (!arrayOfValues)
            return [];
    ...
    'destroyAll': function (arrayOfValues) {
        ...
        // If you passed an arg, we interpret it as an array of Entry to destroy
        if (!arrayOfValues)
            return [];
...
(function() {
    ...
    function mapJsObjectGraph(rootObject, mapInputCallback, visitedObjects) {
        ...
        visitPropertiesOrArrayEntry(rootObject, function(indexer) {
    ...
    function visitPropertiesOrArrayEntry(rootObject, visitorCallback) {
...
(function () {
    ...
    ko.renderTemplateForEach = function (template, arrayOrObservableArray, options, targetNode, parentBindingContext) {
        ...
        return ko.dependentObservable(function () {
            ...
            // Filter out any Entry marked as destroyed
